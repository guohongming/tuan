...
public class CatController {
    ...
    @RequestMapping("/cat")
    public ModelAndView cat(HttpServletRequest request, @RequestParam("type") String type) {
        ...
        List<Product> products = productRepository.queryAllByTypeEquals(type);
        map.put("userInfo", commonUtil.getUserByToken(token));
        map.put("products", products);
        map.put("type", type.equals("food")?"美食":"酒店");
